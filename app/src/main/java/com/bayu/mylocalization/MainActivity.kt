package com.bayu.mylocalization
...
import com.bayu.mylocalization.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pokeCount = 3
        val hello = resources.getString(R.string.hello_world,"Nerenda Wicaksono",pokeCount,"Yoza Aprilio")
